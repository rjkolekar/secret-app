...
//     fetch(`https://graph.facebook.com/v13.0/122145955220021688/published_posts?access_token=${accessToken}`)
//       .then(response => {
//         if (response.ok) {
//           return response.json();
//         }
...
//           .then(data => {
//             if (data && data.data.length > 0) {
//               const page = data.data.find(page => page.id === '61553800960517'); // Replace with your page ID
//               if (page) {
//                 const pageAccessToken = page.access_token;
...
//   useEffect(() => {
//     document.cookie = 'fblo_888977032574831=value; SameSite=None; Secure';
//   }, []);
//   useEffect(() => {
